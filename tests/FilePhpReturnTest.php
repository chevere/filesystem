...
final class FilePhpReturnTest extends TestCase
{
    ...
    {
        $phpFilePath = __DIR__ . '/src/return-string.php';
    ...
    {
        $phpFilePath = __DIR__ . '/src/return-object.php';
        $file = filePhpReturnForPath($phpFilePath);
    ...
    public function testPut(): void
    {
        foreach ([
            ...
            $this->assertSame($value, $this->filePhpReturn->typed()->{$type}());
        }
        ...
        foreach ($types as $type => $value) {
            ...
            $this->assertEquals($value, $this->filePhpReturn->typed()->{$type}());
        }
    }
